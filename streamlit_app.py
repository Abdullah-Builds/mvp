...
#                 if ecg_lab_optional else
#                 "These fields are required — pre-filled with training-set medians."
#             )
...
def generate_lifestyle_plan(prediction, values, language="English"):
    ...
    lifestyle_fields = {
        ...
        if k in {
            "Smoking Status", "Alcohol", "Physical Activity",
            "Daily Sitting (hrs)", "Sleep Duration (hrs)", "Stress Level",
            "BMI (kg/m²)",
        }
    }
    ...
    try:
        ...
        if groq_client is None:
            ...
            if ai_summary and not str(ai_summary).startswith("__ERROR__"):
                ...
                st.warning(f"AI summary unavailable: {ai_summary.replace('__ERROR__:', '')}")
            ...
            if st.button(
                ...
                with st.spinner("Building your personalized lifestyle plan..."):
                    st.session_state.prediction[plan_cache_key] = generate_lifestyle_plan(
            ...
            for lang_option in ["English", "Urdu"]:
                ...
                if plan_text and lang_option == ai_language:
                    if str(plan_text).startswith("__ERROR__"):
                        st.warning(f"Lifestyle plan unavailable: {plan_text.replace('__ERROR__:', '')}")
                    else:
                        st.markdown(
                            f"""
